...
class NaryTreePreorderTraversal: XCTestCase {
    ...
    func testExampleA() {
        let root = GenericNode.parseTree(from: [1, nil, 3, 2, 4, nil, 5, 6])
        XCTAssertEqual(solution.preorder(root), [1, 3, 5, 6, 2, 4])
    }
    
    func testExampleB() {
        let root = GenericNode.parseTree(from: [1, nil, 2, 3, 4, 5, nil, nil, 6, 7, nil, 8, nil, 9, 10, nil, nil, 11, nil, 12, nil, 13, nil, nil, 14])
